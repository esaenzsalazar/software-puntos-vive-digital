...
class Rol(models.Model):
    rol_cdgo = models.AutoField(primary_key=True, db_column='ROL_CDGO')
...
# --- Núcleo (Servicios, Prestamos, Satisfacción) ---
...
# --- Atención (La tabla que une todo) ---

class Atencion(models.Model):
    atn_cdgo = models.AutoField(primary_key=True, db_column='ATN_CDGO')
    ciu = models.ForeignKey(Ciudadano, on_delete=models.DO_NOTHING, db_column='CIU_CDGO')
    ...
    atn_hrfin = models.TimeField(db_column='ATN_HRFIN', null=True)
...
# --- Recursos y Operadores ---

class Recurso(models.Model):
    rec_cdgo = models.AutoField(primary_key=True, db_column='REC_CDGO')
